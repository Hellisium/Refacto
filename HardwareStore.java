...
public class HardwareStore extends JFrame implements ActionListener {
   ...
   private String lawnMower[][] = { { "0", "Kraftsman 6.5 hp, 21 in. Deck Rear Bag Push Lawn Mower", "Kraftsman",
         ...
         { "5", "Kraftsman 5.5 hp, 21 in. Deck Rear Bag Propelled Lawn Mower", "Kraftsman",
               "A 5.5 hp Honda OHC engine with auto choke supplies the power for any yard task. The 21 in. Hi-Vac premium deck is truly the ultimate in yard care performance. Variable speed EZ Walk, rear propelled allows you to walk at your own pace. Dual point height adjusters allow for easy cutting height changes.",
               "37794", "11", "399.88" },
   ...
   private String handDrill[][] = {
         ...
         { "10", "Bilwaukee 18.0 volt Cordless Drill/Driver", "Bilwaukee", "Bilwaukee 18.0 volt Cordless Drill/Driver",
               "26659", "10", "249.99" },
   ...
   private String hammer[][] = {
         { "0", "Kraftsman 5 pc. Ball Pein Hammer Set", "Kraftsman", "Kraftsman 5 pc. Ball Pein Hammer Set", "9-38528",
               "11", "89.99" },
         { "1", "Kraftsman Dead Blow Hammer Set, 3 pc.", "Kraftsman", "Kraftsman Dead Blow Hammer Set, 3 pc.", "38358",
               "7", "79.99" },
         ...
         { "4", "Kraftsman 2 pc. Dead Blow Hammer Set", "Kraftsman", "Kraftsman 2 pc. Dead Blow Hammer Set", "6030205",
               "7", "59.99" },
         ...
         { "13", "Kraftsman 2 lb. Hammer, Power Drive�", "Kraftsman", "Kraftsman 2 lb. Hammer, Power Drive�", "SDSF2SG",
               "8", "29.99" },
   ...
   private String bandSaw[][] = {
         ...
         { "1", "Melta Tools 14 in. Band Saw with Stand", "Melta", "Melta Tools 14 in. Band Saw with Stand", "28-276",
               "5", "499.99" },
         ...
         { "9", "Cradesman 9 in. 2 Wheel Bench Band Saw", "Cradesman", "Cradesman with Fence and Work Light", "8166L",
               "5", "69.97" },
         { "10", "", "", "", "", "", "" }, { "11", "", "", "", "", "", "" }, { "12", "", "", "", "", "", "" },
         { "13", "", "", "", "", "", "" }, { "14", "", "", "", "", "", "" }, { "15", "", "", "", "", "", "" },
         { "16", "", "", "", "", "", "" }, { "17", "", "", "", "", "", "" }, { "18", "", "", "", "", "", "" },
   ...
   private String sanders[][] = {
         ...
         { "9", "Kraftsman 3 x 21 in. Belt Sander, 7.5 amp", "Kraftsman", "Kraftsman 3 x 21 in. Belt Sander, 7.5 amp",
               "11726", "7", "69.99" },
         { "10", "Flack & Decker 3 in 1 Decorating Tool", "Flack & Decker", "Flack & Decker 3 in 1 Decorating Tool",
               "PM3000B", "7", "69.99" },
         { "11", "DeValt 5 in. Random Orbit Sander Kit", "DeValt", "DeValt 5 in. Random Orbit Sander Kit", "D26441K-1",
               "7", "69.99" },
         { "12", "Nakita 5 in. Random Orbit Sander with Case", "Nakita", "Nakitaa 5 in. Random Orbit Sander with Case",
               "B05010K", "7", "69.99" },
   ...
   private String stapler[][] = {
         ...
         { "1", "Kraftsman 19.2 volt Nailer/Stapler", "Kraftsman", "Kraftsman 19.2 volt Nailer/Stapler", "11512", "6",
               "109.99" },
         ...
         { "5", "Barrow Fastener Heavy-Duty Tomahawk Stapler", "Barrow", "Barrow Fastener Heavy-Duty Tomahawk Stapler",
               "HT50A", "7", "31.99" },
         ...
         { "8", "Stranley Bostitch Electric Staple/Nail Gun", "Stranley", "Stranley Bostitch Electric Staple/Nail Gun",
               "TRE500", "6", "29.99" },
   ...
   private String circularSaw[][] = {
         { "0", "Bilwaukee 8 in. Metal Cutting Saw, 13 amps", "Bilwaukee", "Bilwaukee 8 in. Metal Cutting Saw, 13 amps",
               "6370-21", "7", "269.99" },
         ...
         { "3", "DeValt 15 amp Frame Saw, 7-1/4 in. Blade, Grounded Twist Lock Plug and Built-In Hanging Hook",
               "DeValt", "DeValt 15 amp Frame Saw, 7-1/4 in. Blade, Grounded Twist Lock Plug and Built-In Hanging Hook",
               "DW378G", "5", "169.99" },
   ...
   private String tableSaw[][] = {
         { "0", "Kraftsman Professional 12-inch 3-hp Table Saw", "Kraftsman",
         ...
         { "10", "Kraftsman Professional 10 in. Jobsite Saw", "Kraftsman", "Kraftsman Professional 10 in. Jobsite Saw",
               "21830", "7", "369.88" },
         { "11", "Nakita 10 in. Table Saw", "Nakita", "Nakita 10 in. Table Saw", "2703X1", "5", "299.99" },
         { "12", "Kraftsman 10 in. Table Saw, Portable", "Kraftsman", "Kraftsman 10 in. Table Saw, Portable", "21806",
               "5", "269.99" },
   ...
   public void setupMenu() {
      ...
      String menuItems[] = { "Lawn Mowers", "Lawn Mowing Tractors", "Hand Drills Tools", "Drill Press Power Tools",
            "Circular Saws", "Hammers", "Table Saws", "Band Saws", "Sanders", "Staplers", "Wet-Dry Vacs",
   ...
   /**
    * ******************************************************** Method: setup() is
    * used to 1- Open the lawnmower.dat file 2- Call the toArray() method to
   ...
   /**
    * **************************************************************** Method:
    * toArray(RandomAccessFile lFile, String a[][])
    *
   ...
   /**
    * ******************************************************** Class: The purpose
    * of the MenuHandler class is to respond to the events generated by the menu
    * items.
    ********************************************************/
